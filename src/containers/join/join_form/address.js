...
export default class AddReceive extends Component{
    constructor(props) {
        ...
        this.state = {
            ...
            city: "",
            county: "",
            provinces: ['请选择省','安徽', '澳门', '北京', '福建', '甘肃', '广东', '广西', '贵州', '海南', '河北', '河南', '黑龙江', '湖北', '湖南', '吉林', '江苏', '江西', '辽宁', '内蒙古', '宁夏', '青海', '山东', '山西', '陕西', '上海', '四川', '台湾', '天津', '西藏', '香港', '新疆', '云南', '浙江', '重庆', '其他'],
            cities: ['请选择市'],
            counties: []
        }
    }
    ...
    render() {
        let id = 0
        return (
            <div className="form margin-top34">
                <div className="col-9 form_content left">
                    <div className="content flex">
                        ...
                        <div className="province_city flex flex1">
                            <div className="select_province flex1 margin-right15">
                                <select className="select province" onChange={this.handleChange.bind(this, "province")}>
                                    {this.state.provinces.map(province => (
                                        <option value={province} key={id++}>{province}</option>
                                    ))}
                                </select>
                            </div>
                            <div className="select_city flex1">
                                <select className="select city flex1" onChange={this.handleChange.bind(this, "city")}>
